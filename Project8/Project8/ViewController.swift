...
class ViewController: UIViewController {
    ...
    @objc func submitTapped(_ sender: UIButton) {
        ...
        if let solutionPosition = solutions.firstIndex(of: answerText) {
            ...
            if score % 7 == 0 {
                let ac = UIAlertController(title: "Well done", message: "Ready for level 2?", preferredStyle: .alert)
    ...
    func wrongAnswer() {
        let ac = UIAlertController(title: "Sorry thats wrong", message: nil, preferredStyle: .alert)
